      ...
      <section className="relative z-10 px-6 md:px-16 pb-16 md:pt-12 pt-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
           ...
           <a 
                href="https://swift-locale-pay.lovable.app/"
                target="_blank" 
                rel="noopener noreferrer"
                className="inline-block w-full sm:w-auto border border-slate-250 hover:bg-blue-600 transition-transform transition-colors px-10 py-4 rounded-2xl font-bold text-black hover:text-white focus:text-white shadow-xl shadow-blue-500/25 whitespace-nowrap text-center">
                TRY THE LIVE DEMO
           </a>
                {/* ModalOverlay */}
